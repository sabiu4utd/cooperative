        ...
        <div class="dashboard-wrapper">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Members Registration Form</h2>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Registration Form
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card mb-5 shadow-sm">
                                  ...
                                  <?php } ?>
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo site_url("admin/registration_data"); ?>" method="post"
                                            id="form" data-parsley-validate="">
                                            <div class="form-group">
                                                <!-- <label for="inputUserName">Membership No.</label> -->
                                                <input id="inputUserName" type="text" name="membershipNo"
                                                    parsley-trigger="change" required="" placeholder="Membership Number"
                                                    autocomplete="off" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <!-- <label for="inputEmail">Staff No.</label> -->
                                                <input id="inputEmail" type="text" name="staffId"
                                                    parsley-trigger="change" required="" placeholder="Staff SP/JP No"
                                                    autocomplete="off" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <!-- <label for="inputPassword">First Name</label> -->
                                                <input id="inputPassword" name="fname" type="text"
                                                    placeholder="First Name" required="" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <!-- <label for="inputRepeatPassword">Surname</label> -->
                                            ...
                                            <div class="form-group">
                                                <!-- <label for="inputRepeatPassword">Other Name</label> -->
                                                <input type="number" name="crs" placeholder="RCS" class="form-control">
                                            </div>
                                ...
                                <div class="card mb-5 shadow-sm">
                                    <h5 class="card-header">Last Registration</h5>
                                    <div class="card-body">
                                        <table class="table table-dark">
                                          <tr>
                                            <td>Membership No</td>
                                            <td><?php echo $lastMember->membershipNo; ?></td>
                                          </tr>
                                          <tr>
                                            <td>Staff Number </td>
                                            <td><?php echo $lastMember->staffId; ?></td>
                                          </tr>
                                          <tr>
                                            <td>Full Name</td>
                                            <td><?php echo $lastMember->fname." ".$lastMember->sname." ".$lastMember->oname; ?></td>
                                          </tr>
                                          <tr>
                                            <td>Email</td>
                                            <td><?php echo $lastMember->email; ?></td>
                                          </tr>
                                          <tr>
                                            <td>Phone Number</td>
                                            <td><?php echo $lastMember->phone; ?></td>
                                          </tr>
                                          <tr>
                                            <td>RCS</td>
                                            <td>N<?php echo $lastMember->crs; ?></td>
                                          </tr>
            ...
            <div class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            2023 © FUBK-SMCS - Designed and Developed by<a href="#" target="_blank"
                                class="ml-1">FUBK-MIS</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
