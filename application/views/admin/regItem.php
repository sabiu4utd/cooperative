                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card mb-5 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo site_url("admin/save_item"); ?>" method="post" id="form" data-parsley-validate="">
                                            <div class="form-group">
                                                <!-- <label for="inputUserName">Membership No.</label> -->
                                                <input id="inputUserName" type="text" name="item" parsley-trigger="change" required="" placeholder="item e.g. Millet" autocomplete="off" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <!-- <label for="inputEmail">Staff No.</label> -->
                                                <input id="inputEmail" type="text" name="qty" parsley-trigger="change" required="" placeholder="Quantity" autocomplete="off" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <!-- <label for="inputEmail">Staff No.</label> -->
                                                <input id="inputEmail" type="text" name="unit_price" parsley-trigger="change" required="" placeholder="Unit Price" autocomplete="off" class="form-control">
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="card mb-5 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php $i=1; foreach($items as $row){?>
                                            ...
                                            <td><a href="<?php echo site_url('admin/deleteItemById/'.$row->id); ?>"><i class="fas fa-fw fa-trash"></i></a></td>
