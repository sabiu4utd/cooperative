        ...
        <div class="splash-container">
            <div class="card shadow-sm">
                <div class="card-header text-center">
                    ...
                    <?php if ($type == "payslip") {
                        echo "<h3>Please upload the most recent payslip</h3>";
                    } else {
                        echo "<h3>Please upload Surety form</h3>";
                    } ?>
                    <br />
                    <form action="<?php echo site_url('member/uploadDocument'); ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group mb-2">
                            <input class="form-control" id="username" type="file" name="filetoupload">
                        </div>
