            ...
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-4">
                ...
                <div class="card shadow-sm h-100">
                  <h5 class="card-header">Deductions History</h5>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <?php $i = 1;
                          $all = 0.0;
                          foreach ($alldeductions as $row) { 
                              $all += $row->amount_requested;
                            ?>
                            <tr>
                              <td><?php echo $i++; ?></td>
                              <td><?php echo $row->type; ?></td>
                              <td>N<?php echo number_format($row->amount_requested, 2); ?></td>
                              <td>
                                <?php 
                          ...
                          <?php echo "Total Amount Deducted as at ".date('d-m-y')."  (N". number_format($all,2).")"; ?>
                        </td>
                      </tr>
                        </tbody>
                      </table>
